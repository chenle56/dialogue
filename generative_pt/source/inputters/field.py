...
class TextField(Field):
    ...
    def __init__(self,
        ...
        self.itos = []      # ['<pad>', '<unk>', '<bos>', '<eos>', 'person_topic_b'a, '<num>', 'person_topic_a',......]
        self.stoi = {}      # {'<pad>': 0, '<unk>': 1, '<bos>': 2, '<eos>': 3, 'person_topic_b': 4, '<num>': 5, 'person_topic_a': 6,.....]
        self.vocab_size = 0
    ...
    def build_vocab(self, texts, min_freq=0, max_size=None):
        ...
        counter = Counter()
        for string in tqdm(texts):             #tqdm:进度条
